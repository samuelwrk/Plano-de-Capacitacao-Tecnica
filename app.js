...
const jogosData = [
    ...
    { id: 6, nome: "Apex Legends", genero: "Battle Royale", desc: "Battle Royale gratuito focado em movimentação fluida e heróis.", img: "https://blog.publicidade.uol.com.br/wp-content/uploads/2019/02/apex-featured-image-16x9.jpg.adapt_.crop191x100.1200w.jpg", plataformas: ["PC", "PlayStation", "Xbox", "Nintendo Switch"], idade: 14, ano: 2019, dev: "Respawn", url: "https://www.ea.com/pt-br/games/apex-legends" }
];

const anoAtual = new Date().getFullYear();

// 2. GRADE E ESTATÍSTICAS
const renderizarInterface = () => {
    // Injeta os cartões de jogos
    ...
    // Cálculos rápidos para as estatísticas (flatMap e Set)
...
const initBusca = () => {
    ...
    // Filtrar dados e atualizar tela
